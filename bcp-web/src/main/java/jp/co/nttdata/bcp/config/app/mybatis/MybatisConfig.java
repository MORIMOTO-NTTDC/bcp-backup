package jp.co.nttdata.bcp.config.app.mybatis;
...
public class MybatisConfig {
    ...
    private static void setTypeAliases(TypeAliasRegistry typeAliasRegistry) {
        typeAliasRegistry.registerAliases("jp.co.nttdata.bcp.domain.model");
        typeAliasRegistry.registerAliases(
                "jp.co.nttdata.bcp.domain.repository");
        // typeAliasRegistry.registerAliases("jp.co.nttdata.bcp.infra.mybatis.typehandler");
    }
    ...
    private static void setTypeHandlers(
        ...
        // typeHandlerRegistry.register("jp.co.nttdata.bcp.infra.mybatis.typehandler");
    }
}
