...
import jp.co.nttdata.bcp.app.common.interceptor.CheckHeaderInterceptor;
...
public class SpringMvcConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		// X-Requested-With のチェック（webapiは除外）
		registry.addInterceptor(new CheckHeaderInterceptor())
				.addPathPatterns("/**/*.do")
				.excludePathPatterns("/webapi/**");
	}
	 ...
	 * @see jp.co.nttdata.bcp.config.app.ApplicationContext#exceptionCodeResolver()
	 ...
	 * @see jp.co.nttdata.bcp.config.app.ApplicationContext#exceptionLogger()
