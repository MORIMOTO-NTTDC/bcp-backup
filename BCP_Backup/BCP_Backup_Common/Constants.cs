namespace CommonLibrary
{
    ...
    {
        // レジストリキーのパス
        public const string RegistryKeySoftware = "Software";

        // レジストリキーのパス
        public const string RegistryKeyBcpsoft = "bcpSoft";

        // レジストリキーのパス
        public const string RegistryKeyPath = RegistryKeySoftware + @"\" + RegistryKeyBcpsoft;

        // BCP Backup Clientのプロセス名
        public const string ClientProcessName = "BCP_Backup_Client";
