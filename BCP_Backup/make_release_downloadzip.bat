...
:CHECK_DIR
set DIST_FOLDER=..\BCP_RELEASE_ZIP\%YYYYMMDD%_%BRANCH_NUM%
...
powershell -Command "Compress-Archive -Path %DIST_FOLDER%\client,%DIST_FOLDER%\service %DIST_FOLDER%\bcps3sync.zip"
